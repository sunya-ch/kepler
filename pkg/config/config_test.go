...
var _ = Describe("Test Configuration", func() {
	...
	It("Test getModelConfigMap", func() {
		configStr := "POD_COMPONENTS_ESTIMATOR=true\nPOD_COMPONENTS_INIT_URL=https://raw.githubusercontent.com/sustainable-computing-io/kepler-model-server/main/tests/test_models/DynComponentPower/CgroupOnly/ScikitMixed/ScikitMixed.json\n"
		os.Setenv("MODEL_CONFIG", configStr)
		configValues := getModelConfigMap()
		modelItem := "POD_COMPONENTS"
